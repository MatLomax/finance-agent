 ...
 * 
 * @param {any} organizedPhases - Phases organized by type from organizeSimulationByPhases
 * @param {number} [taxRate=0.15] - Tax rate for investment income calculations
 * @returns {HTMLElement} Container with all phase tables
 * 
 * @example
 ...
 */
export function createPhaseTables(organizedPhases, taxRate = 0.15) {
