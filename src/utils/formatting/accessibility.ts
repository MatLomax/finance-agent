 ...
 * 
 */
export function getAccessibleColors(type: string, highContrast: any = false): any {
 ...
 * 
 */
export function getResponsiveFontSize(importance: string, isMobile: any = false): any {
