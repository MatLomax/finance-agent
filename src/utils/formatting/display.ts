 ...
 * 
 */
export function formatPhaseLabel(phase: string, isActive: any = false): string {
 ...
 * 
 */
export function formatAgeRange(startAge: number, endAge: number, isCurrentAge: any = false): string {
