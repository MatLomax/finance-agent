 ...
 * 
 */
export function organizeSimulationByPhases(simulation: any[], emergencyFundTarget: number): any {
 ...
 */
function processYearForPhases(yearData: any, index: number, simulation: any[], emergencyFundTarget: number, milestones: any): any {
  const firstYear = simulation[0];
 ...
 */
function calculateYearChanges(yearsFromStart: number, prevYear: any, yearData: any): any {
 ...
 */
function assignToPhase(phases: any, yearData: any, emergencyFundTarget: number): any {
